...
export function getStats(db: Database.Database, projectRoot?: string, indexing?: boolean) {
...
export function getFiles(db: Database.Database) {
  return db.prepare(`
...
export function getChunksByFile(db: Database.Database, filepath: string) {
  return db.prepare(
